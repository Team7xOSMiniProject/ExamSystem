...
private:
    ...
    static bool handle_authentication(int sock, const string& command,
    const string& user_type, const string& username, const string& password);    
    ...
    static void sendAvailableExams(int sock, const string& username, 
